...
export class PeriodEligibleParticipantComponent {
  ...
  constructor(private periodService: PeriodService, 
    ...
    this.sub = this.route
      ...
      .subscribe(params => {
        ...
        this.nameTrainingChoosed = params['name'];
    });
  ...
  deleteEligibleParticipant(eligibleData: EligibleParticipantPeriod){
    this.periodService.deleteEligibleParticipant(eligibleData.eligibleNumber).subscribe(((res) => {
      this.result = res;
      if(this.result == true){
