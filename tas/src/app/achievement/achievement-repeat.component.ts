...
@Component({
    selector: 'tas-achievement-repeat',
    templateUrl: 'achievement-repeat.component.html',
    styleUrls: ['./achievement-repeat.component.css']
})
export class AchievementRepeatComponent implements OnInit {
